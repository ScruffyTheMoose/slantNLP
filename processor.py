...
class PreProcess:
    ...
    def removeEmoji(textBody: string) -> string:
    ...
    def tokenizeString(emojiless_textbody: string) -> list:
    ...
    def makeLowerCase(tked_list : list) -> list:
        text_lowcase = []
    ...
    def removeStopWords(LC_list: list) -> list:
    ...
    def lemmatizer(word_list: list) -> list:
...
class Sentiment:
    ...
    def sentiment(text: string) -> dict:
